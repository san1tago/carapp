  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top", "bottom"]}>
      ...
      <ScrollView contentContainerStyle={styles.body}>
        ...
        <View style={styles.infoBox}>
          <Text style={styles.infoTxt}>
            💡 Información: Los seguros adicionales como todo riesgo no son
            obligatorios por ley, pero ofrecen mayor protección para tu
            vehículo.
          </Text>
        </View>
      </ScrollView>
      ...
      <View style={styles.footer}>
        <Pressable
          onPress={save}
          disabled={!canSave || !endDate}
          style={[styles.save, { opacity: canSave && endDate ? 1 : 0.35 }]}
        >
          <Text style={styles.saveTxt}>
            {saving ? "Guardando..." : "Guardar seguro adicional"}
          </Text>
        </Pressable>
      </View>
    </SafeAreaView>
