...
// "05/06/2027" → Date restando N días
    ...
    <SafeAreaView style={styles.safe} edges={["top", "bottom"]}>
      ...
      <ScrollView contentContainerStyle={styles.body} keyboardShouldPersistTaps="handled">
        ...
        >
          {expiryDate ? (
            <Text style={styles.expiryText}>
              🔴 Se vence el: {formatDateLong(expiryDate)}
            </Text>
          ) : (
        ...
        <PhotoInput
          ...
          onChange={(uri) =>
            updateVehicle(v.id, { soat: { ...v.soat, photoUri: uri } })
          }
        />
        ...
        <View style={styles.remList}>
          ...
          {reminders.map((days, index) => {
            const selectedOption = reminderOptions.find((o) => o.days === days)?.label || "";
            ...
            return (
              ...
              >
                ...
                {/* Fecha en que se enviará */}
                {reminderDate ? (
                  <Text style={styles.reminderDateTxt}>
                    📩 Se enviará el {reminderDate}
                  </Text>
                ) : null}
